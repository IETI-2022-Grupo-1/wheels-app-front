  ...
  return (
    <div className='profileHeader profileHeader__container'>
      ...
      <div className='profileHeader__information'>
        ...
        {isDriver && (
          <div className='profileHeader__info'>
            <p className='profileHeader__info--model'>
              {selectedVehicle.description || vehicleDescription} ·{' '}
            </p>
            <p className='profileHeader__info--plate'>
              &#9733; {selectedVehicle.licensePlate || vehiclePlate}
            </p>
          </div>
        )}
        ...
        <div className='profileHeader__cta--container'>
          ...
          <button className='profileHeader__update-profile-logout' onClick={() => logoutUser()}>
            Cerrar sesión
          </button>
        </div>
      </div>
